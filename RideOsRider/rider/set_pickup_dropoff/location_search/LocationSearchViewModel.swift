...
public protocol LocationSearchViewModel {
    ...
    var initialState: Observable<LocationSearchInitialState> { get }
}

public struct LocationSearchInitialState: Equatable {
    public let pickupSearchBoxState: LocationSearchBoxState
    public let dropoffSearchBoxState: LocationSearchBoxState
    public let focus: LocationSearchFocusType

    public init(pickupSearchBoxState: LocationSearchBoxState,
                dropoffSearchBoxState: LocationSearchBoxState,
                focus: LocationSearchFocusType) {
        self.pickupSearchBoxState = pickupSearchBoxState
        self.dropoffSearchBoxState = dropoffSearchBoxState
        self.focus = focus
    }
}
