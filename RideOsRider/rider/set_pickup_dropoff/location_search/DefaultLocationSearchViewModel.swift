...
public class DefaultLocationSearchViewModel: LocationSearchViewModel {
    public static let defaultInitialState = LocationSearchInitialState(
        pickupSearchBoxState: LocationSearchBoxState(location: nil, enabled: true),
        dropoffSearchBoxState: LocationSearchBoxState(location: nil, enabled: true),
        focus: .dropoff
    )
    ...
    private let initialStateValue: LocationSearchInitialState

    public init(schedulerProvider: SchedulerProvider = DefaultSchedulerProvider(),
                listener: LocationSearchListener,
                initialState: LocationSearchInitialState = DefaultLocationSearchViewModel.defaultInitialState,
        ...
        doneActionEnabled =
            initialState.pickupSearchBoxState.location != nil && initialState.dropoffSearchBoxState.location != nil
    ...
    public var initialState: Observable<LocationSearchInitialState> {
        return Observable.just(initialStateValue)
    }
}
